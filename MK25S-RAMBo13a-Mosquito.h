//Changes
//8/7 - Changed Y position from -4 to 0
//8/15 - V2: Updated extruder steps and decreased X axis feed rate from 200 to 130, 172 to 120 for silent, and accel from 1000 to 800
#ifndef CONFIGURATION_PRUSA_H
#define CONFIGURATION_PRUSA_H

#include <limits.h>
#include "printers.h"
#include "thermal_model/mosquito.h"

#define THERMAL_MODEL_DEFAULT MOSQUITO
...
// Printer name
#define CUSTOM_MENDEL_NAME "Prusa i3 MK2.5S Bear Mosquito"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,100,3200/8,415} // E used to be 133
...
#define Y_MIN_POS -4                    //Changed from 0 to -4
...
#define DEFAULT_MAX_FEEDRATE          {130, 200, 12, 120}      // (mm/sec)   max feedrate (M203)
#define DEFAULT_MAX_FEEDRATE_SILENT         {120, 172, 12, 120}      // (mm/sec)   max feedrate (M203), silent mode
#define DEFAULT_MAX_ACCELERATION      {800, 1000, 200, 5000}  // (mm/sec^2) max acceleration (M201)
...
#else
// Define PID constants for extruder Changed from commended to below
...
#define BED_ADJUSTMENT_UM_MAX 200   //Dane update from 100 to 200
